...
var blockPays = /[0-9a-zA-ZàèìòùÀÈÌÒÙáéíóúýÁÉÍÓÚÝâêîôûÂÊÎÔÛãñõÃÑÕäëïöüÿÄËÏÖÜŸçÇßØøÅåÆæœÉ]+(?:(?:\'| |\-|\?|\(|\)|\.|\,|\;|\:)?[a-zA-ZàèìòùÀÈÌÒÙáéíóúýÁÉÍÓÚÝâêîôûÂÊÎÔÛãñõÃÑÕäëïöüÿÄËÏÖÜŸçÇßØøÅåÆæœÉ]+)*$/;// on prendra 5 nombres entier */
...
if(!blockPays.test(pays.value)){
    event.preventDefault();
    missPays.innerHTML = "Veuillez saisir votre date de sejour";
